...
const PROJECTS = [
  {
    ...
    demo: "https://example.com/projects/trainers",
  ...
  },
  {
    ...
    lang: "Go",
    status: "online",
    tagline: "In-memory KV база с TCP-сервером",
    concept: "WAL с group commit · future/promise · recovery на старте",
    demo: "https://example.com/projects/kv",
    source: "https://github.com/zik-zikurrat/kv-store",
  },
  {
    id: "c-structures",
    name: "c-structures",
    lang: "C",
    status: "offline",
    tagline: "Структуры данных на голом C",
    concept: "Generic slice через void* · hash map с FNV-1a · separate chaining",
    demo: null,
    source: "https://github.com/zik-zikurrat/c-structures",
  },
  {
    id: "esp32-lab",
    name: "esp32-lab",
    lang: "Rust",
    status: "offline",
    tagline: "Bare-metal на ESP32",
    concept: "no_std · embedded-hal · working with peripherals without RTOS",
    demo: null,
    source: "https://github.com/zik-zikurrat/esp32-lab",
  },
];
